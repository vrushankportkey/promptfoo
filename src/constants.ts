...
export const REMOTE_API_BASE_URL =
  ...
  global.process.env.NEXT_PUBLIC_PROMPTFOO_REMOTE_API_BASE_URL ||
  global.process.env.NEXT_PUBLIC_PROMPTFOO_BASE_URL ||
  global.process.env.PROMPTFOO_REMOTE_API_BASE_URL ||
  `https://api.promptfoo.dev`;

// This is used for viewing evals.
export const REMOTE_APP_BASE_URL =
  global.process.env.NEXT_PUBLIC_PROMPTFOO_BASE_URL ||
  global.process.env.PROMPTFOO_REMOTE_APP_BASE_URL ||
